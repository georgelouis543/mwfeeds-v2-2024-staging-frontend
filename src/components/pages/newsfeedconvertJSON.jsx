...
const NewsfeedconvertJSON = () => {
  ...
  return (
    <div className='flex flex-col justify-between items-top w-full h-full px-2 2xl:px-16 py-7 gap-10'>
        ...
        {previewData.length > 0 && (<div className='flex w-full justify-center'>
            <button className="w-[150px] flex-shrink-0 bg-black hover:bg-black border-black hover:border-black text-sm border-4 text-white py-1 px-2 rounded" type="button" onClick={handleConvert}>
                Convert
            </button>
        </div>)}
    </div>
