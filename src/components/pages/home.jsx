...
const toggleCheckbox = (feedId) => {
  ...
  return (
    <div className='flex flex-col justify-between items-top w-full h-full px-2 2xl:px-16 py-7'>
      <div className='flex justify-between items-center'>
        ...
        <div className='ml-auto py-5 px-2 text-xl font-bold'>
          Action Menu
        </div>
      </div>
          ...
          <tbody>
            ...
            {feeds.map(feed => (
                ...
                />
                    ...
                    <td className="px-6 py-4"><div className='flex justify-center'><a href={feed.feed_link} target='__blank'>{feed.feed_link}</a></div></td>
                    ...
                    <td className="px-6 py-4 text-center"><Link to={`/editFeed/${feed.feed_id}`}>Edit</Link>/Delete</td>
                </tr>
            ))}
        </tbody>
        </table>
